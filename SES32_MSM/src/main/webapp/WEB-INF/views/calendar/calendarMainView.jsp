		...
		<div id="my_form">
			<table>
				...
				<tr>
					...
					</select> <br> <select class="sel" id="repeat" style="margin-top: 3px;"
				...
				<tr>
					<th>알람</th>
					<td><select class="sel" id="alarm" onchange="alarmChanged();">
			...
			<div style="text-align: center;">
				<input type="button" name="save" value="Save" id="save"
					...
					type="button" name="close" value="Close" id="close"
					style='width: 100px;' onclick="close_form()"> <input
					type="button" name="delete" value="Delete" id="delete"

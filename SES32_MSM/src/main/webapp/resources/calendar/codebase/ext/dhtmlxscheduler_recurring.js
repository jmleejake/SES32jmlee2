...
scheduler.__recurring_template='<div class="dhx_form_repeat"> <form> <div class="dhx_repeat_left"> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="day" />일간 </label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="week"/>주간</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="month" checked />월간</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="year" />연간</label> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_center"> <div style="display:none;" id="dhx_repeat_day"> <label><input class="dhx_repeat_radio" type="radio" name="day_type" value="d"/>매</label><input class="dhx_repeat_text" type="text" name="day_count" value="1" />일<br /> <label><input class="dhx_repeat_radio" type="radio" name="day_type" checked value="w"/>평일마다</label> </div> <div style="display:none;" id="dhx_repeat_week"><input class="dhx_repeat_text" type="text" name="week_count" value="1" />주 간격:<br /> <table class="dhx_repeat_days"> <tr> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="1" />월요일</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="4" />목요일</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="2" />화요일</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="5" />금요일</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="3" />수요일</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="6" />토요일</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="0" />일요일</label><br /><br /> </td> </tr> </table> </div> <div id="dhx_repeat_month"> <label><input class="dhx_repeat_radio" type="radio" name="month_type" value="d"/>해당 월의</label><input class="dhx_repeat_text" type="text" name="month_day" value="1" />일에<input class="dhx_repeat_text" type="text" name="month_count" value="1" />개월 간격<br /> <label><input class="dhx_repeat_radio" type="radio" name="month_type" checked value="w"/>해당 월의</label><input class="dhx_repeat_text" type="text" name="month_week2" value="1" />번째 주<select name="month_day2"><option value="1" selected >월요일<option value="2">화요일<option value="3">수요일<option value="4">목요일<option value="5">금요일<option value="6">토요일<option value="0">일요일</select><input class="dhx_repeat_text" type="text" name="month_count2" value="1" />개월 간격<br /> </div> <div style="display:none;" id="dhx_repeat_year"> <label><input class="dhx_repeat_radio" type="radio" name="year_type" value="d"/></label>매년<select name="year_month"><option value="0" selected >1월<option value="1">2월<option value="2">3월<option value="3">4월<option value="4">5월<option value="5">6월<option value="6">7월<option value="7">8월<option value="8">9월<option value="9">10월<option value="10">11월<option value="11">12월</select><input class="dhx_repeat_text" type="text" name="year_day" value="1" />일<br /> <label><input class="dhx_repeat_radio" type="radio" name="year_type" checked value="w"/></label>매년<select name="year_month2"><option value="0" selected >1월<option value="1">2월<option value="2">3월<option value="3">4월<option value="4">5월<option value="5">6월<option value="6">7월<option value="7">8월<option value="8">9월<option value="9">10월<option value="10">11월<option value="11">12월</select><input class="dhx_repeat_text" type="text" name="year_week2" value="1" />째주<select name="year_day2"><option value="1" selected >월요일<option value="2">화요일<option value="3">수요일<option value="4">목요일<option value="5">금요일<option value="6">토요일<option value="7">일요일</select><br /> </div> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_right"> <label><input class="dhx_repeat_radio" type="radio" name="end" checked/>무기한</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="end" /></label><input class="dhx_repeat_text" type="text" name="occurences_count" value="1" />번 발생후 종료<br /> <label><input class="dhx_repeat_radio" type="radio" name="end" /></label><input class="dhx_repeat_date" type="text" name="date_of_end" value="'+scheduler.config.repeat_date_of_end+'" />까지<br /> </div> </form> </div> <div style="clear:both"> </div>';
